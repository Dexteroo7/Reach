 ...
 */
class ListAdapterWithMore extends SimpleRecyclerAdapter<App, AppItemHolder> {

    public ListAdapterWithMore(List<App> messageList, HandOverMessage<App> handOverMessage, int resourceId) {
