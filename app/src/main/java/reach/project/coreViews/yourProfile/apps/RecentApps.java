...
// Source file: proto/recentapp.proto
...
final class RecentApps extends Message {
    ...
    public RecentApps(String title, List<App> appList) {
        this.title = title;
        this.appList = immutableCopyOf(appList);
    }

    private RecentApps(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof RecentApps)) return false;
        RecentApps o = (RecentApps) other;
    ...
    public static final class Builder extends Message.Builder<RecentApps> {
        ...
        public Builder(RecentApps message) {
            super(message);
        ...
        @Override
        public RecentApps build() {
            return new RecentApps(this);
        }
    }
}
