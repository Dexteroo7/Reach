package reach.project.utils.auxiliaryClasses;// Code generated by Wire protocol buffer compiler, do not edit.
...
public final class Playlist extends Message {
  ...
  public Playlist(List<Long> reachSongs, String playlistName, String dateModified, Boolean visibility) {
  ...
  private Playlist(Builder builder) {
    this(builder.reachSongs, builder.playlistName, builder.dateModified, builder.visibility);
    setBuilder(builder);
  }
