...
public final class Song extends Message {
  ...
  public Song(Long songId, Long size, Boolean visibility, Integer year, Long dateAdded, Long duration, String genre, String displayName, String actualName, String artist, String album, String albumArtUrl, String formattedDataAdded, String fileHash, String path, String artistMBID, String releaseGroupMBID, Boolean isLiked) {
    this.songId = songId;
    this.size = size;
  ...
  private Song(Builder builder) {
    this(builder.songId, builder.size, builder.visibility, builder.year, builder.dateAdded, builder.duration, builder.genre, builder.displayName, builder.actualName, builder.artist, builder.album, builder.albumArtUrl, builder.formattedDataAdded, builder.fileHash, builder.path, builder.artistMBID, builder.releaseGroupMBID, builder.isLiked);
    setBuilder(builder);
  }
  ...
  public boolean equals(Object other) {
    ...
    return equals(songId, o.songId)
        ...
        && equals(path, o.path)
        && equals(artistMBID, o.artistMBID)
  ...
  public int hashCode() {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (artistMBID != null ? artistMBID.hashCode() : 0);
