 ...
 * @hide
 */
class MySuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public MySuggestionsAdapter(Context context, MySearchView searchView, SearchableInfo searchable,
