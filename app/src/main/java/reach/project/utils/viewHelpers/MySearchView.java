...
/**
 * Created by gauravsobti on 31/03/16.
 *//*
...
import static reach.project.utils.viewHelpers.MySuggestionsAdapter.getColumnString;
...
public class MySearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private Runnable mReleaseCursorRunnable = new Runnable() {
        public void run() {
            if (mSuggestionsAdapter != null && mSuggestionsAdapter instanceof MySuggestionsAdapter) {
    ...
    public MySearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final int layoutResId = a.getResourceId(
                android.support.v7.appcompat.R.styleable.SearchView_layout, android.support.v7.appcompat.R.layout.abc_search_view);
        ...
        mSearchPlate.setBackgroundDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_queryBackground));
        mSubmitArea.setBackgroundDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_submitBackground));
        mSearchButton.setImageDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_searchIcon));
        mGoButton.setImageDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_goIcon));
        mCloseButton.setImageDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_closeIcon));
        mVoiceButton.setImageDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_voiceIcon));
        mCollapsedIcon.setImageDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_searchIcon));

        mSearchHintIcon = a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_searchHintIcon);

        // Extract dropdown layout resource IDs for later use.
        mSuggestionRowLayout = a.getResourceId(android.support.v7.appcompat.R.styleable.SearchView_suggestionRowLayout,
                android.support.v7.appcompat.R.layout.abc_search_dropdown_item_icons_2line);
        mSuggestionCommitIconResId = a.getResourceId(android.support.v7.appcompat.R.styleable.SearchView_commitIcon, 0);
        ...
        final int maxWidth = a.getDimensionPixelSize(android.support.v7.appcompat.R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }

        mDefaultQueryHint = a.getText(android.support.v7.appcompat.R.styleable.SearchView_defaultQueryHint);
        mQueryHint = a.getText(android.support.v7.appcompat.R.styleable.SearchView_queryHint);

        final int imeOptions = a.getInt(android.support.v7.appcompat.R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }

        final int inputType = a.getInt(android.support.v7.appcompat.R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }

        boolean focusable = true;
        focusable = a.getBoolean(android.support.v7.appcompat.R.styleable.SearchView_android_focusable, focusable);
        ...
        mDropDownAnchor.setBackgroundColor(ContextCompat.getColor(context,android.R.color.white));
    ...
    public void setQueryRefinementEnabled(boolean enable) {
        ...
        if (mSuggestionsAdapter instanceof MySuggestionsAdapter) {
            ((MySuggestionsAdapter) mSuggestionsAdapter).setQueryRefinement(
                    enable ? MySuggestionsAdapter.REFINE_ALL : MySuggestionsAdapter.REFINE_BY_ENTRY);
        }
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources()
                .getDimensionPixelSize(android.support.v7.appcompat.R.dimen.abc_search_view_preferred_width);
    }
    ...
    private void updateSearchAutoComplete() {
        ...
        if (mSearchable.getSuggestAuthority() != null) {
            mSuggestionsAdapter = new MySuggestionsAdapter(getContext(),
                    this, mSearchable, mOutsideDrawablesCache);
            mSearchSrcTextView.setAdapter(mSuggestionsAdapter);
            ((MySuggestionsAdapter) mSuggestionsAdapter).setQueryRefinement(
                    mQueryRefinement ? MySuggestionsAdapter.REFINE_ALL
                            : MySuggestionsAdapter.REFINE_BY_ENTRY);
        }
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (mDropDownAnchor.getWidth() > 1) {
            ...
            final int width = mDropDownAnchor.getWidth() + dropDownPadding.left
                    + dropDownPadding.right + iconOffset - anchorPadding + 100;
