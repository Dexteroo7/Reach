        ...
        switch (viewType) {
            ...
            case VIEW_TYPE_FRIEND: {
                return new FriendsViewHolder(LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.myreach_item, parent, false), this);
            }
...
//        final short networkType = cursor.getShort(4);
            ...
            horizontalViewHolder.bindTest(position);
            horizontalViewHolder.mTextView2.setText("Newly added");
            horizontalViewHolder.mRecyclerView2.setLayoutManager(
                    new CustomLinearLayoutManager(holder.itemView.getContext(),
                            LinearLayoutManager.HORIZONTAL, false));
            horizontalViewHolder.mRecyclerView2.setAdapter(lockedFriendsAdapter);
        }
    }
