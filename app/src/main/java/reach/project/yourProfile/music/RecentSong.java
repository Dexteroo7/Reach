package reach.project.yourProfile.music;// Code generated by Wire protocol buffer compiler, do not edit.
// Source file: proto/recentsong.proto
...
public final class RecentSong extends Message {
    ...
    public RecentSong(String title, List<Song> songList) {
        this.title = title;
        this.songList = immutableCopyOf(songList);
    }

    private RecentSong(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof RecentSong)) return false;
        RecentSong o = (RecentSong) other;
    ...
    public static final class Builder extends Message.Builder<RecentSong> {
        ...
        public Builder(RecentSong message) {
            super(message);
