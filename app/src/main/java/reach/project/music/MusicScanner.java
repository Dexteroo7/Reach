...
//    private enum ScanApplications {
//
//        ;
//
//        private List<App> getApplications(PackageManager packageManager, SharedPreferences preferences) {
//
...
//
//            final Set<String> hiddenPackages = Collections.emptyEnumeration();
...
//                appBuilder.visible(!hiddenPackages.contains(appBuilder.packageName));
