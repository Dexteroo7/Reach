...
public final class Song extends Message {
    ...
    public static final class Builder extends Message.Builder<Song> {
        ...
        public SimpleSong buildSimple() {

            final SimpleSong simpleSong = new SimpleSong();

            simpleSong.setSongId(songId);
            simpleSong.setSize(size);
            simpleSong.setVisibility(visibility);
            simpleSong.setYear(year);
            simpleSong.setDateAdded(dateAdded);
            simpleSong.setDuration(duration);
            simpleSong.setGenre(genre);
            simpleSong.setDisplayName(displayName);
            simpleSong.setActualName(actualName);
            simpleSong.setAlbum(album);
            simpleSong.setArtist(artist);
            simpleSong.setFileHash(fileHash);
            simpleSong.setPath(path);
            simpleSong.setIsLiked(isLiked);
