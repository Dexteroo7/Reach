package reach.project.music.playLists;// Code generated by Wire protocol buffer compiler, do not edit.
...
public final class Playlist extends Message {
  ...
  @ProtoField(tag = 5)
  public final ListOfAlbumArtData listOfAlbumArtData;

  public Playlist(List<Long> reachSongs, String playlistName, String dateModified, Boolean visibility, ListOfAlbumArtData listOfAlbumArtData) {
    this.reachSongs = immutableCopyOf(reachSongs);
    this.playlistName = playlistName;
    this.dateModified = dateModified;
    this.visibility = visibility;
    this.listOfAlbumArtData = listOfAlbumArtData;
  }

  private Playlist(Builder builder) {
    this(builder.reachSongs, builder.playlistName, builder.dateModified, builder.visibility, builder.listOfAlbumArtData);
    setBuilder(builder);
  }
  ...
  public boolean equals(Object other) {
    ...
    return equals(reachSongs, o.reachSongs)
        ...
        && equals(listOfAlbumArtData, o.listOfAlbumArtData);
  }
  ...
  public int hashCode() {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (listOfAlbumArtData != null ? listOfAlbumArtData.hashCode() : 0);
      hashCode = result;
    }
    return result;
  }
  ...
  public static final class Builder extends Message.Builder<Playlist> {
    ...
    public ListOfAlbumArtData listOfAlbumArtData;
    ...
    public Builder(Playlist message) {
      ...
      this.listOfAlbumArtData = message.listOfAlbumArtData;
    }
    ...
    public Builder listOfAlbumArtData(ListOfAlbumArtData listOfAlbumArtData) {
      this.listOfAlbumArtData = listOfAlbumArtData;
      return this;
    }
