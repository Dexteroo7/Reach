...
public final class Song extends Message {
  ...
  public Song(Long songId, Long size, Boolean visibility, Integer year, Long dateAdded, Long duration, String genre, String displayName, String actualName, String artist, String album, String fileHash, String path, Boolean isLiked) {
    this.songId = songId;
    this.size = size;
  ...
  private Song(Builder builder) {
    this(builder.songId, builder.size, builder.visibility, builder.year, builder.dateAdded, builder.duration, builder.genre, builder.displayName, builder.actualName, builder.artist, builder.album, builder.fileHash, builder.path, builder.isLiked);
    setBuilder(builder);
  }
